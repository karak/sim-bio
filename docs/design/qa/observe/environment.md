...
| `belltree_mature` | 3,917 | ≤ 4,000 | 9.85 × 9.91 × 10.22(試作 3 で房を大きくした) | bark, leaf, bell, bell_rim(鐘 30 個、M22-06 で裾を開いた、M22-07 で樹冠を房 8 つに分けた) |
| `belltree_mature_lod1` | 1,112 | ≤ 1,200 | 10.24 × 10.09 × 10.28(試作 3 で房を大きくした) | bark, leaf, bell, bell_rim(鐘 30 個、位置は成木と同じ、M22-07 で房 8 つ) |
