...
- [ ] 月鹿の装甲板と瞳の形の忠実度を上げる(試作 1 への判断、2026-09-23)
- [x] 狼と兎の造形の手直し: 狼の鼻づら(狐寄り)と樽形の胴、兎の平たい陰影と離れた六角(試作 2 への判断 5、2026-09-24)
- [ ] 月鹿の食むアニメの作り直し(2026-09-24 00:32、ユーザー): 「首だけおもちゃのように上下を繰り返すのはおかしい。食べるときは一定、頭を下ろしたままだし、動きももっと前足を曲げて全身を落とすでしょう」。
  頭を下ろしたまま保ち(上げ下げは時々、ゆっくり)、前足を曲げて前半身ごと沈める。口元の小さな動きと、ときどき一歩進む。
- [ ] 月鹿の倒れるアニメで角が地面下 0.93 m まで刺さる(兎の担当の検証で発見)
