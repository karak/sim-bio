...
- [x] 地面・海岸・植生が基準画(sheet-terrain / sheet-flora / sheet-belltree)との比較画で合格 → 手元の審査台で合格: 地面 g2-ground(dc5a344)、鐘樹 t3-bells・段 t3-stages・遠距離版 t3-lod(d3ac5f4)、小花 t4-flower(4dfa851)、草の影 t2-grass-shadow
- [x] 沈降で海岸線が動き、植えた鐘樹が芽吹く(本体の密度に従う) → 沈む海岸 e2-sinking・芽吹き e3-sprout 合格(M22-07)
- [ ] 予算内で 60fps
...
- [x] 鐘樹の段(t03-belltree 不合格): 「そもそもBlenderのモデルが荒いママなので評価対象外。なお、切り株やマルタは樹木とくらべて精細化がされていない状態」— 芽・若木・株・丸太を成木の磨き上げと同じ水準へ → t3-stages 合格(d3ac5f4)
- [x] 下草(t03-flora 保留): 「鐘樹の段(芽・若木・成木・株・丸太)におなじ」 → t4-flower 合格(4dfa851)
- [x] 林(t03-grove 保留): 「光は遮光と空気に関しては、かなりよくなった。一方で地面側や動物の陰影などはモデルも含めてまだ課題が残る。それとは別に鐘の釣り方が枝と揃っていないため、蜂の巣や実のような生えものにみえてしまう」— 鐘を枝から吊る(枝の位置に合わせる)。地面・動物の陰影 → 鐘は t3-bells 合格、地面は g2-ground 合格。動物の陰影は M22-05 の造形の区切りの残課題へ
- [x] 海岸と地面(t03-coast 判定なし): 「よくなったのは確かであり、弁別性という意味では十分。地面の肌触りは依然薄く、アクションならともかく箱庭としてはもういっぽざらつきや凹凸などの質感がほしい」 → g2-ground 合格(dc5a344)
- [x] 木の並び(p-trees-ref 合格): 「葉っぱの生え方が自然物に見えにくいが、ゲームとしては許容」 → 合格(メモのとおり許容)
- [x] 確かめる(p-trees-settlement 合格): 「直接関係ないが、草に樹のシャドウが落ちていない」— 今の組み立て(草の遠距離版・影の代わりの形の後)で草が木の影を受けているか → t2-grass-shadow 合格
- 2026-09-24 23:13 手元の審査台(http://localhost:5390/)での判断(542ba13 の鐘樹の段・鐘・下草・草の影):
  - [x] 鐘の吊り方(t2-bells 不合格): 「高さが揃いすぎており、不気味。枝の位置自体が悪いのかもしれない。ところで、樹とのサイズ感はあっているのか？」 → t3-bells 合格
  - [x] 段(t2-stages メモ): 「マルタや切り株に苔はいらないでしょ」 → t3-stages 合格
  - [x] 下草(t2-flora メモ): 「しだ、花の葉部分はもう少し高くても良いのでは」 → t3-flora の茎の件のあと t4-flower 合格
...
- 2026-09-25 00:39 手元の審査台での判断(d3ac5f4 の鐘樹 3 回目):
  ...
  - [x] 段(t3-stages 合格)
  - [x] 小物の遠距離版(t3-lod 合格)
  - [x] 下草(t3-flora 不合格): 「小花の根元の茎と草の位置がずれているのはなぜ？」— 原因: `flower_patch()` の葉 5 枚は株の中心(原点)から立ち上がるのに、茎 7 本は中心から 4〜20 cm 離れた輪に植えている。葉が地に伏せていた頃の置き方のまま葉だけ立ち上げたので、茎が葉の外の地面から生えて見える → t4-flower 合格(4dfa851)
- 2026-09-25 08:07 手元の審査台での判断: 地面の起伏と小石(g2-ground、dc5a344)合格、小花の茎の付け根(t4-flower、4dfa851)合格
